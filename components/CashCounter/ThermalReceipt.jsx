    ...
    <div className="sf-receipt">
          ...
          * {
          ...
          .sf-receipt {
            ...
            */
            ...
            /*
              Thermal heads render anti-aliased grey edges as no-dot, so
              smoothing + a plain regular weight makes print look faint.
              Bold + a light stroke-thickening shadow fixes that; last
              time this looked smudged because the item table text was
              still tiny (8.3px) — now that everything below is sized up,
              the same trick reads as dark/crisp instead of blobby.
            */
      ...
      ====================================== */}
        ...
        CASH MEMO
            ...
            <div className="sf-r-center  sf-r-titles">
